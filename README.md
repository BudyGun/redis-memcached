# Домашнее задание к занятию «Кеширование Redis/memcached» - Чумаков Константин
...
3. Непрерывность получения данных во время пиковых нагрузок обращений к БД. Кеширование может улучшить доступность данных, так как оно может предоставить быстрый доступ к данным, даже если источник данных недоступен. 
